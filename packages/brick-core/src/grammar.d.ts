...
export type StartRuleNames = "BrickFile";
export interface ParseOptions<T extends StartRuleNames = "BrickFile"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"BrickFile">>(
  input: string,
  options?: Options,
): any;
